# Agent-developed goals — product

**Owner:** `cpo` — this agent writes and maintains this file itself.
...
- **Every goal cites its tenet.** Shared: `T1`–`T5`. This domain: `P1`,
  `P2`, … A goal serving no tenet should not exist.
