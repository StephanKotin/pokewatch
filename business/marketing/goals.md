# Agent-developed goals — marketing

**Owner:** `cmo` — this agent writes and maintains this file itself.
...
- **Every goal cites its tenet.** Shared: `T1`–`T5`. This domain: `M1`,
  `M2`, … A goal serving no tenet should not exist.
