# Agent-developed goals — design

**Owner:** `vp-design` — this agent writes and maintains this file itself.
...
- **Every goal cites its tenet.** Shared: `T1`–`T5`. This domain: `D1`,
  `D2`, … A goal serving no tenet should not exist.
