# Agent-developed goals — engineering

**Owner:** `cto` — this agent writes and maintains this file itself.
...
- **Every goal cites its tenet.** Shared: `T1`–`T5`. This domain: `E1`,
  `E2`, … A goal serving no tenet should not exist.
